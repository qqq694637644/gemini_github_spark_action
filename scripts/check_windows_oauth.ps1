...
$health = Invoke-WebRequest -Uri $healthUrl -UseBasicParsing -SkipHttpErrorCheck
...
$resourceMetadata = Invoke-WebRequest -Uri $resourceMetadataUrl -UseBasicParsing -SkipHttpErrorCheck
...
$authorizationMetadata = Invoke-WebRequest -Uri $authorizationMetadataUrl -UseBasicParsing -SkipHttpErrorCheck
...
$challenge = Invoke-WebRequest -Uri $mcpUrl -Method Head -UseBasicParsing -SkipHttpErrorCheck
